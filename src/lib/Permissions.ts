const permissions = ["Access", "ManageEvents", "ManageUsers", "ManageSlots", "ManageDownloads", "ManagePermissions"] as const;

type PermissionFlags = (typeof permissions)[number];
export type PermissionResolvable = number | number[] | PermissionFlags | PermissionFlags[] | Permissions | Permissions[];
